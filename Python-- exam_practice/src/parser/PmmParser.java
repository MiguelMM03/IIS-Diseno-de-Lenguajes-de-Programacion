...
public class PmmParser extends Parser {
	...
	public static final int
		...
		TRASH=39, INT_CONSTANT=40, REAL_CONSTANT=41, BOOLEAN_CONSTANT=42, COMMENT=43, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "TRASH", "INT_CONSTANT", "REAL_CONSTANT", "BOOLEAN_CONSTANT", 
	...
	public final Main_functionContext main_function() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 60473142762504L) != 0)) {
				{
				{
				setState(57);
	...
	public final Function_definitionContext function_definition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 532576075776L) != 0)) {
				{
				setState(104);
	...
	public final Params_auxContext params_aux() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 60473142673416L) != 0)) {
				{
				setState(213);
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			case T__37:
				...
				{
				setState(339);
				((TypeContext)_localctx).STRUCT = match(T__37);
				setState(340);
				match(T__5);
				setState(346);
				_errHandler.sync(this);
