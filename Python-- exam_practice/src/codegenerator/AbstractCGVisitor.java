...
public class AbstractCGVisitor<TP,TR> implements Visitor<TP,TR> {
    ...
    public TR visit(BooleanLiteral ast, TP param) {
        throw new IllegalStateException("Exception in visit BooleanLiteral");
    }
    ...
    @Override
    public TR visit(BooleanType ast, TP param) {
        throw new IllegalStateException("Exception in visit BooleanType");
    }
